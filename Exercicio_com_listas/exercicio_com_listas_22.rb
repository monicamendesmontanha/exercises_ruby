...
# ]
 ...
 identificacao = [
  Identificadores.new('a', "necessita da esfera", 0),
  Identificadores.new('b', "necessita de limpeza", 0),
  Identificadores.new('c', "necessita troca de cabo ou conector", 0),
  Identificadores.new('d', "quebrado ou inutilizado", 0)
 ]
